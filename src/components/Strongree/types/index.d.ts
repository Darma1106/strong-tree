...
export type CallBackBeforeFn = (treeId: string, treeNode: ITreeNode) => boolean | Promise<boolean>
export type CallBackOnFn = (event: Event, treeId: string, treeNode: ITreeNode) => void | Promise<void>
...
export type removeFnType<T> = (treeId: string, treeNode: ITreeNode) => T
...
export type dblClickExpandFn<T> = (treeId: string, treeNode: ITreeNode) => T
...
export type filterFnType = (node: ITreeNode) => boolean
...
export interface IzTree<T = any> {
  init: (dom: any, setting: ISetting, zNodes: ITreeNode[] | T) => IzTreeObj
